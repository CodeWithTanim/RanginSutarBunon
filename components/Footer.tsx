    ...
    <footer className="bg-white text-gray-700 pt-16 pb-8 border-t border-gray-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 mb-12 border-b border-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div className="flex items-center gap-4 justify-center md:justify-start">
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-900">100% Authentic Quality</h4>
              <p className="text-xs text-gray-500 mt-0.5">Crafted with care & tradition</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 justify-center md:justify-start">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">Reach out anytime to our team</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-2 space-y-4">
          <Link href="/" className="font-serif text-2xl font-bold text-[#003d29] tracking-tight block">
            {settings.siteTitle || 'Rangin Sutar Bunon'}
          </Link>
          <p className="text-sm text-gray-600 max-w-md leading-relaxed">
            {settings.footerAboutText || 'Celebrating rich quality and authentic craftsmanship through finest woven items.'}
          </p>
